...
#ctid=physical location of the row version of the table

def extract_start_and_end_page(rctid): #get the start and end page of the table
    min_ctid = rctid[0]
...
#cs2 does sampling based halving, if that doesnt fail we do the sampling halving otherwise we do the binary halving
    def do_binary_halving(self, core_sizes,
        ...
        while start_page < end_page - 1:
            ...
            #we essentially keep on halving the currently largest page, and do so untill we have only 1 page
